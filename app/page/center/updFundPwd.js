...
export default class UpdFundPwd extends Component {
    ...
    validOldPwd = () => {
        ...
        } else if(!Verify.fundsPassword.test(oldPwd)) {
            this.setState({
                oldPwdText: '密码为6位数字!',
                oldPwdValid: false,
                isValid: false
    ...
    validNewPwd = () => {
        ...
        } else if(!Verify.fundsPassword.test(newPwd)) {
            this.setState({
                newPwdText: '密码为6位数字!',
                newPwdValid: false,
                isValid: false
    ...
    validRepeatPwd = () => {
        ...
        } else if(!Verify.fundsPassword.test(repeatPwd)) {
            this.setState({
                repeatPwdText: '密码为6位数字!',
                repeatPwdValid: false,
                isValid: false
            })
    ...
    toSubmit = () => {
        ...
        const { navigation } = this.props;
        service.updateFundPwdService({
            oldFundsPassword: oldPwd,
            newFundsPassword: newPwd
        })
        .then(res => {
            this.setState({ isConnecting: false });
            // this._alert.alert("","密码修改成功!",[
            //     {text:"确定",onPress:this.toLogout}
            // ]);
            showToast('密码修改成功!', {

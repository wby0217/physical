...
import TopUpRecordDetail from './getCashRecordDetail';

const { width } = Dimensions.get('window');
export default class GetCashRecord extends Component {
    constructor(props) {
        super(props)
        this.state = {
            datalist: [],
    ...
    fetchData = () => {
        ...
        service.withdrawRecordsService({ typeId: selectedTypeId, page: this.pageIndex })
        .then(res => {

...
const ScrollableTabBar = createReactClass({
    ...
    renderTab(name, page, isTabActive, onPressHandler, onLayoutHandler) {
        ...
        >
          <View style={[styles.tab, this.props.tabStyle, bgColor, { borderRadius: 15 }]}>
    ...
    render() {
        ...
        >
          ...
          >
            <View
              style={[styles.tabs, { width: this.state._containerWidth , backgroundColor: '#fff', borderRadius: 15 }]}
              ref={'tabContainer'}

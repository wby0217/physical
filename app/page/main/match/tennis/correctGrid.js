        ...
        <Grid style={{ paddingRight: 6, marginTop: 10 }}>
          ...
          <Row style={{ height: 200 }}>
            ...
            <Col size={2.5} style={[styles.bgWhite, { borderLeftColor: '#B6B6B6', borderLeftWidth: StyleSheet.hairlineWidth }]}>
              {
                (() => {
                  const args = (['iorH2c0', 'correctScore', curGameInfo.games[0].odds['correctScore'].iorH2c0]).concat([curGameInfo.games[0].gameId, '2#0', n.parlayMin || [], n.parlayMax || []]);
                  const isActive = this.isActive(args);
                  return (curGameInfo.games[0].odds['correctScore'].iorH2c0) ?
                    <Row
                      ...
                      >
                        <View>
                          <Text style={isActive ? styles.activeTextClass : null}>
                            {curGameInfo.games[0].odds['correctScore'].iorH2c0}
                          </Text>
                        </View>
              ...
              {
                (() => {
                  const args = ['iorH2c1', 'correctScore', curGameInfo.games[0].odds['correctScore'].iorH2c1].concat([curGameInfo.games[0].gameId, '2#1', n.parlayMin || [], n.parlayMax || []]);
                  const isActive = this.isActive(args);
                  return (<Row style={[styles.gridRightTopColor]}>
                    {(curGameInfo.games[0].odds['correctScore'].iorH2c1) ?
                      <TouchableOpacity
                        activeOpacity={1}
                        onPress={() => { // 主 2-1
                          onSelected(args);
              ...
              {(() => {
                const args = ['iorH3c0', 'correctScore', curGameInfo.games[0].odds['correctScore'].iorH3c0].concat([curGameInfo.games[0].gameId, '3#0', n.parlayMin || [], n.parlayMax || []]);
                const isActive = this.isActive(args);
                return (
                  <Row style={[styles.gridRightTopColor]}>
                    {(curGameInfo.games[0].odds['correctScore'].iorH3c0) ?
                      <TouchableOpacity
                        activeOpacity={1}
                        onPress={() => { // 主 3-0
                          onSelected(args);
                      ...
                      >
                        <Text style={[isActive ? styles.activeTextClass : null]}>{curGameInfo.games[0].odds['correctScore'].iorH3c0}</Text>
                        <View style={{ width: 20, alignItems: 'center' }}>
              ...
              {
                (() => {
                  const args = ['iorH3c1', 'correctScore', curGameInfo.games[0].odds['correctScore'].iorH3c1].concat([curGameInfo.games[0].gameId, '3#1', n.parlayMin || [], n.parlayMax || []]);
                  const isActive = this.isActive(args);
                  return (<Row style={[styles.gridRightTopColor]}>
                    {(curGameInfo.games[0].odds['correctScore'].iorH3c1) ?
                      <TouchableOpacity
                        activeOpacity={1}
                        onPress={() => { // 主 3-1
                          onSelected(args);
                      ...
                      >
                        ...
                        <Text style={[isActive ? styles.activeTextClass : null]}>{curGameInfo.games[0].odds['correctScore'].iorH3c1}</Text>
                        <View style={{ width: 20, alignItems: 'center' }}>
              ...
              {(() => {
                const args = ['iorH3c2', 'correctScore', curGameInfo.games[0].odds['correctScore'].iorH3c2, curGameInfo.games[0].gameId, '3#2', n.parlayMin || [], n.parlayMax || []];
                const isActive = this.isActive(args);
                return (
                  <Row style={[styles.gridRightTopColor]}>
                    {(curGameInfo.games[0].odds['correctScore'].iorH3c2) ?
                      <TouchableOpacity
                        activeOpacity={1}
                        onPress={() => { // 主 3-2
                          onSelected(args);
                        ...
                        style={[{ flex: 1, justifyContent: 'flex-end', alignItems: 'center', flexDirection: 'row' }, isActive ? styles.activeViewClass : null]}
                      >
                        <Text style={[isActive ? styles.activeTextClass : null]}>{curGameInfo.games[0].odds['correctScore'].iorH3c2}</Text>
                        <View style={{ width: 20, alignItems: 'center' }}>
            ...
            <Col size={2.5} style={styles.bgWhite}>
              {(() => {
                const args = ['iorH0c2', 'correctScore', curGameInfo.games[0].odds['correctScore'].iorH0c2].concat([curGameInfo.games[0].gameId, '0#2', n.parlayMin || [], n.parlayMax || []]);
                const isActive = this.isActive(args);
                return (<Row style={[styles.gridRightTopColor, { borderTopColor: '#B6B6B6', borderTopWidth: StyleSheet.hairlineWidth }]}>
                  {curGameInfo.games[0].odds['correctScore'].iorH0c2 ?
                    <TouchableOpacity
                      activeOpacity={1}
                      onPress={() => { // 客 0-2
                        onSelected(args);
                    ...
                    >
                      <View>
                        <Text style={isActive ? styles.activeTextClass : null}>{curGameInfo.games[0].odds['correctScore'].iorH0c2}</Text>
                      </View>
                      <View style={{ width: 20, alignItems: 'center' }}>
              ...
              {(() => {
                const args = ['iorH1c2', 'correctScore', curGameInfo.games[0].odds['correctScore'].iorH1c2].concat([curGameInfo.games[0].gameId, '1#2', n.parlayMin || [], n.parlayMax || []]);
                const isActive = this.isActive(args);
                return (
                  <Row style={[styles.gridRightTopColor]}>
                    {(curGameInfo.games[0].odds['correctScore'].iorH1c2) ?
                      <TouchableOpacity
                        activeOpacity={1}
                        onPress={() => { // 客 1-2
                          onSelected(args);
                      ...
                      >
                        <View>
                          <Text style={isActive ? styles.activeTextClass : null}>{curGameInfo.games[0].odds['correctScore'].iorH1c2}</Text>
                        </View>
                        <View style={{ width: 20, alignItems: 'center' }}>
              ...
              {(() => {
                const args = ['iorH0c3', 'correctScore', curGameInfo.games[0].odds['correctScore'].iorH0c3].concat([curGameInfo.games[0].gameId, '0#3', n.parlayMin || [], n.parlayMax || []]);
                const isActive = this.isActive(args);
                return (
                  <Row style={[styles.gridRightTopColor]}>
                    {(curGameInfo.games[0].odds['correctScore'].iorH0c3) ?
                      <TouchableOpacity
                        activeOpacity={1}
                        onPress={() => { // 客 0-3
                          onSelected(args);
                      ...
                      >
                        <View>
                          <Text style={isActive ? styles.activeTextClass : null}>{curGameInfo.games[0].odds['correctScore'].iorH0c3}</Text>
                        </View>
                        <View style={{ width: 20, alignItems: 'center' }}>
              ...
              {(() => {
                const args = ['iorH1c3', 'correctScore', curGameInfo.games[0].odds['correctScore'].iorH1c3].concat([curGameInfo.games[0].gameId, '1#3', n.parlayMin || [], n.parlayMax || []]);
                const isActive = this.isActive(args);
                return (
                  <Row style={[styles.gridRightTopColor]}>
                    {(curGameInfo.games[0].odds['correctScore'].iorH1c3) ?
                      <TouchableOpacity
                        activeOpacity={1}
                        onPress={() => { // 球员局数大小-客/大
                          onSelected(args);
                      ...
                      >
                        <View>
                          <Text style={isActive ? styles.activeTextClass : null}>{curGameInfo.games[0].odds['correctScore'].iorH1c3}</Text>
                        </View>
                        <View style={{ width: 20, alignItems: 'center' }}>
              ...
              {(() => {
                const args = ['iorH2c3', 'correctScore', curGameInfo.games[0].odds['correctScore'].iorH2c3, curGameInfo.games[0].gameId, '2#3', n.parlayMin || [], n.parlayMax || []];
                const isActive = this.isActive(args);
                return (
                  <Row style={[styles.gridRightTopColor]}>
                    {(curGameInfo.games[0].odds['correctScore'].iorH2c3) ?
                      <TouchableOpacity
                        activeOpacity={1}
                        onPress={() => { // 球员局数大小-客/小
                          onSelected(args);
                      ...
                      >
                        <View>
                          <Text style={isActive ? styles.activeTextClass : null}>{curGameInfo.games[0].odds['correctScore'].iorH2c3}</Text>
                        </View>
                        <View style={{ width: 20, alignItems: 'center' }}>

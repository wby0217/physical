...
import { Nodata, Alert, Succtips, OverlaySpinner } from '../../../../component/tips';
...
import MatchGrid from '../grid/allOrHalfGrid';

let prevGameId = List([]);
let prevActiveId = List([]);
const moduleKey = "ht_ft";
const isIos = Platform.OS === 'ios';
class AllOrHalf extends Component {
    constructor(props) {
        super(props)
        this.state = {
...
export default connect(mapStateToProps, mapDispatchToProps)(AllOrHalf);
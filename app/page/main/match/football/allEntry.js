...
import MatchGrid from '../grid/allEntryGrid';

let prevGameId = List([]);
let prevActiveId = List([]);
const moduleKey = "total_goals";
const isIos = Platform.OS === 'ios';
class AllEntry extends Component {
    constructor(props) {
        super(props)
        this.state = {
    ...
    refreshData = () => {
        ...
        const args = { sportType: navigation.state.params && navigation.state.params.engName, eventType: matchEventType.typeEngName, playTypeGroup: 'total_goals', pageAll: this.pageIndex, matches: AllianceId || 0 }
    ...
    fetchData(params = {}) {
        ...
        const args = { sportType: navigation.state.params && navigation.state.params.engName, eventType: matchEventType.typeEngName, playTypeGroup: 'total_goals', page: this.pageIndex, order: orderType, pageAll: params.pageAll || 0, matches: AllianceId || 0 };
...
export default connect(mapStateToProps, mapDispatchToProps)(AllEntry);
...
import MatchGrid from './correctHalfGrid';
import TennisCorrectGrid from '../tennis/correctGrid';

let prevGameId = List([]);
let prevActiveId = List([]);
const isIos = Platform.OS === 'ios';
const moduleKey = "1h_correct_score";
    ...
    refreshData = () => {
        ...
        .catch(err => {
            if(err.errorcode === 100009) {
                ...
                this.setState({ isConnecting: false }, () => ErrorHandle(err))
            }
        })
    }
    fetchData(params = {}) {
